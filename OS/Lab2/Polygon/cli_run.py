...
def main():
    ...
    for i in range(1, clients+1):
        ...
        if sys.platform == "win32":
            os.system(f".\\tcpclient.exe 192.168.67.130:9005 file_{i}.txt")
        elif sys.platform == "linux":
            os.system(f"./udpclient 192.168.67.130:9005 file_{i}.txt")
    if sys.platform == "win32":
        os.system(f".\\tcpclient.exe 192.168.67.130:9005 file_{clients+1}.txt")
    elif sys.platform == "linux":
        os.system(f"./udpclient.exe 192.168.67.130:9005 file_{clients+1}.txt")
