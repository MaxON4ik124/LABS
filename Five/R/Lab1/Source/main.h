...
// =========================
#ifndef TANKI_FORCEINLINE
#if defined(_MSC_VER)
#define TANKI_FORCEINLINE __forceinline
#else
#define TANKI_FORCEINLINE inline
#endif
#endif

static TANKI_FORCEINLINE float dist2f(float x1, float y1, float x2, float y2)
{
    float dx = x2 - x1;
    float dy = y2 - y1;
    return dx * dx + dy * dy;
...
static TANKI_FORCEINLINE float clampf(float v, float a, float b)
{
...
#define KEY "!]$m0MK90g0GJ@zQn@t/CX0fJPQmCND[QldCR!0Jg]g&0J3BQlSDQndCQ0JTQng=="
#define PASSWORD "\x57\x20\x03\x01\x5c\x2e\x4a\x62\x09\x4f\x27"
#define SERIALKEY "\x7b\x0e\x69\x43\x51\x02\x28\x61\x0d\x3c\x0e\x6e\x7c\x33\x69\x21\x21\x2d\x06\x27\x0f\x57\x11\x22\x52\x1d\x04\x12\x69\x78\x7e\x27\x09\x14\x16\x2b\x35\x73\x21\x5a\x1f\x06\x08\x4b\x5f\x67\x1d\x44\x3d\x63\x7f\x0b\x32\x29\x17\x7e\x7c"
#define TANKSUM 0xAE7D7E69
#define POLYNOMINAL 0xEDB88320
