...
timeout $TIMEOUT clang++ -shared -DIMYSTRING="\"${SRC_PATH}${MYSTRING_H}\"" -O3 -std=c++11 -fPIC $(/venv/bin/python3 -m pybind11 --includes) -lpython3.12 /src/MyString.cpp /src/MyString_wrapper.cpp -o "$BINDING_PATH"
